<html lang="en" googleoff:all="" translate="no"
    style="--vh: 5.64px; --primary: #f03ec3; --bg: linear-gradient(180deg, #f03ec3 16.19%, #f03ec3 23.12%, #FFF6F5 97.67%); --bg-login: linear-gradient(180deg, #f03ec3 16.19%, rgba(0, 102, 255, 0.00) 64.99%, #fff 100%); --bg-input: #BBCFF3; --btn-bg: #64D0FF; --btn-bg2: #2141FF; --btn-shadow: 2px 6px 10px 0px rgba(1, 103, 255, 0.12); --bg-tab: #f03ec3; --mine-card: #206155;">

<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no">
    <meta name="google" content="notranslate">
    <title>Zam Zam Investr</title>
    <script type="module" crossorigin="" src="/assets/index-8a8d410f.js"></script>
    <link rel="modulepreload" crossorigin="" href="/assets/tabbar-6ac2140b.js">
    <link rel="stylesheet" href="/assets/tabbar-a37584c8.css">
    <link rel="stylesheet" href="/assets/index-2e2b8352.css">
    <link type="image/x-icon" rel="shortcut icon"
        href="https://babaoss.oss-accelerate-overseas.aliyuncs.com/upload/20231009/99940c5dbb316285432d041502e649ec.png">
    <link rel="modulepreload" as="script" crossorigin="" href="/assets/index-7e9a288d.js">
    <link rel="modulepreload" as="script" crossorigin="" href="/assets/route-block-83d24a4e.js">
    <link rel="modulepreload" as="script" crossorigin="" href="/assets/login-9748648d.js">
    <link rel="modulepreload" as="script" crossorigin="" href="/assets/ContainerLogin-137f8116.js">
    <link rel="modulepreload" as="script" crossorigin="" href="/assets/BaseMainBtn-10c88668.js">
    <link rel="stylesheet" href="/assets/BaseMainBtn-5f24e787.css">
    <link rel="modulepreload" as="script" crossorigin="" href="/assets/ContainerForm-6996ab18.js">
    <link rel="stylesheet" href="/assets/ContainerForm-4e418d51.css">
    <link rel="modulepreload" as="script" crossorigin="" href="/assets/PhoneSelect-5698d332.js">
    <link rel="modulepreload" as="script" crossorigin="" href="/assets/BaseInput-235bc08b.js">
    <link rel="stylesheet" href="/assets/BaseInput-0de00a31.css">
    <link rel="modulepreload" as="script" crossorigin=""
        href="/assets/BaseUserTab.vue_vue_type_style_index_0_lang-92436947.js">
    <link rel="stylesheet" href="/assets/BaseUserTab-c449726b.css">
    <link rel="stylesheet" href="/assets/login-b9f55d24.css">
    <link rel="modulepreload" as="script" crossorigin="" href="/assets/team-779db25a.js">
    <link rel="stylesheet" href="/assets/team-79ad0f96.css">
...
<body class="">
    <div id="app" data-v-app="" class="a-t-2">
        <div data-v-2d156be6="" class="layout-tab-bar box-border min-h-full w-full px-$mg pb-60px">
            <div data-v-2d156be6="" class="nav-bar-wrap is-scroll-state" style="--4751cdd3: 0.5785714285714286;">
                <div class="nav-bar"><!---->
                    <div id="navBarItem2" class="nav-bar-content h-full w-full" style="--2e6b2e2c: 25px;">
                        <div class="left">
                            <div class="base-help-btn cursor-pointer"><svg
                                    class="svg-icon icon-1-help :uno: text-16px :uno: text-16px">
                                    <use xlink:href="#icon-1-help"></use>
                                </svg></div>
                            <div class="base-alarm-logo-btn cursor-pointer"><svg
                                    class="svg-icon icon-1-email :uno: text-16px :uno: text-16px">
                                    <use xlink:href="#icon-1-email"></use>
                                </svg><!----></div>
                        </div>
                        <p class="name font-crafter" style="font-size: 25px !important;">
                        <div class=":uno: base-logo flex items-center small-logo"><img
                                class="site-img h-90px w-90px rd-70%"
                                src="/logo.png"
                                draggable="false" alt="logo" h-full="" w-full=""><!----></div><p style="color:white">Zam Zam Investr</p>
                        <div class="right">
                            <div>
                                <div class="base-lang-wrap"><svg
                                        class="svg-icon icon-1-lang :uno: mr-3px text-16px :uno: mr-3px text-16px">
                                        <use xlink:href="#icon-1-lang"></use>
                                    </svg><span>English</span><svg
                                        class="svg-icon icon-1-arrow2 :uno: ml-4px text-10px :uno: ml-4px text-10px">
                                        <use xlink:href="#icon-1-arrow2"></use>
                                    </svg></div>
                            </div>
                        </div>
                    </div><!----><!----><!---->
            ...
            <div data-v-0b24035f="" class="team-wrap">
                ...
                <div data-v-0b24035f="" class="team-wrap-content">
                    ...
                    <div data-v-2d156be6="" class=":uno: tab-bar-wrap tab-bar-wrap-2 fixed bottom-0 z-2">
                        <div class="tab-bar">


                            <div onclick="location.href='/user/dashboard';" class="tab-item"><!---->
                                <div data-v-c99600e1="" id="tabItem" class="tab-item-inner">
                                    <div data-v-c99600e1="" class="tab-item-icon i-ph:house-fill c-$text-gray"></div>
                                    <!----><!----><!----><!---->
                                    <div data-v-c99600e1="" class="tab-item-label">Home</div>
                                </div><!----><!----><!---->
                            </div>

                            <div onclick="location.href='/user/invest/log';" class="tab-item"><!---->
                                <div data-v-c99600e1="" id="tabItem" class="tab-item-inner"><!---->
                                    <div data-v-c99600e1=""
                                        class="tab-item-icon i-solar:clipboard-list-bold c-$text-gray"></div>
                                    <!----><!----><!---->
                                    <div data-v-c99600e1="" class="tab-item-label">Mission</div>
                                </div><!----><!----><!---->
                            </div>

                            <div onclick="location.href='/user/referrals';" class="tab-item"><!---->
                                <div data-v-c99600e1="" id="tabItem" class="tab-item-inner active"><!----><!---->
                                    <div data-v-c99600e1="" class="tab-item-icon i-ooui:user-group-ltr c-$primary">
                                    </div><!----><!---->
                                    <div data-v-c99600e1="" class="tab-item-label">Team</div>
                                </div><!----><!----><!---->
                            </div>

                            <div onclick="location.href='/plan';" class="tab-item"><!---->
                                <div data-v-c99600e1="" id="tabItem" class="tab-item-inner"><!----><!----><!---->
                                    <div data-v-c99600e1="" class="tab-item-icon i-ion:diamond c-$text-gray"></div>
                                    <!---->
                                    <div data-v-c99600e1="" class="tab-item-label">VIP</div>
                                </div><!----><!----><!---->
                            </div>

                            <div onclick="location.href='/user/profile-setting';" class="tab-item"><!---->
                                <div data-v-c99600e1="" id="tabItem" class="tab-item-inner">
                                    <!----><!----><!----><!---->
                                    <div data-v-c99600e1=""
                                        class="tab-item-icon i-ant-design-golden-filled c-$text-gray"></div>
                                    <div data-v-c99600e1="" class="tab-item-label">Me</div>
                                </div><!----><!----><!---->
                            </div>
                        </div>
                    </div>
